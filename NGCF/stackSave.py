...
if __name__ == '__main__':
    ...
    *********************************************************
    ...
    # netease 20
    # pretrain_path = '/data/prj2020/zss/ngcf/weights/netease/ngcf_norm_ngcf_l3/64-64-64/l0.0001_r1e-05/'
    # BPRMF newNetease
    pretrain_path = '/data/prj2020/zss/ngcf/NGCF/weights/newNeatease/ngcf_norm_ngcf_l3/64-64-64/l0.0001_r1e-05/'
    ...
    if ckpt and ckpt.model_checkpoint_path:
        ...
        model.pos_i_g_embeddings = tf.convert_to_tensor(np.load('/data/prj2020/zss/ngcf/NGCF/npyData/bgcn_items.npy'))
        model.u_g_embeddings = tf.convert_to_tensor(np.load('/data/prj2020/zss/ngcf/NGCF/npyData/bgcn_users.npy'))
        


    save_saver = tf.train.Saver()
    save_saver.save(sess, '/data/prj2020/zss/ngcf/NGCF/stackModel/epoch',global_step=1)
