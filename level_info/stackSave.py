...
if __name__ == "__main__":
    ...
    *********************************************************
    ...
    if ckpt and ckpt.model_checkpoint_path:
        ...
        model.pos_i_g_embeddings = tf.convert_to_tensor(
            np.load("/data/prj2020/zss/ngcf/NGCF/npyData/bgcn_items.npy")
        )
        model.u_g_embeddings = tf.convert_to_tensor(
            np.load("/data/prj2020/zss/ngcf/NGCF/npyData/bgcn_users.npy")
        )
