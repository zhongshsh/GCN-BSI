...
class NGCF(object):
    ...
    def save(self):
        ...
        pos_i_g_embeddings = tf.nn.embedding_lookup(
            self.ia_embeddings, list(range(2820))
        )
...
if __name__ == "__main__":
    ...
    *********************************************************
    ...
    # pretrain_path = '/home/user02/zss/ngcf/NGCF/Stackweights/newNeatease/ngcf_norm_ngcf_l3/128-128-128/l0.0001_r1e-05'
    # pretrain_path = '/home/user02/zss/ngcf/NGCF/weights/steamgame/ngcf_norm_ngcf_l3/64-64-64/l0.0001_r1e-05/'
    # pretrain_path = '/home/user02/zss/ngcf/NGCF/Stackweights/steamgame/ngcf_norm_ngcf_l3/128-128-128/l0.0001_r1e-05'
    # pretrain_path = '/home/user02/zss/ngcf/result_newNetease/stackModel/ngcf_norm_ngcf_l3/128-128-128/l0.0001_r1e-05/'
    # pretrain_path = './20210510-SomeWeight/ELweights/newNeatease/ngcf_norm_ngcf_l1/256/l0.0001_r1e-05/'
    ...
    # save_saver.save(sess, '/home/user02/zss/ngcf/NGCF/elModel')
